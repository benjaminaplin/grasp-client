...
var contact_details_1 = require('./pages/contact-details')
...
function App() {
  var _a = (0, react_1.useState)('light'),
    mode = _a[0],
    setMode = _a[1]
  var colorMode = (0, react_1.useMemo)(function () {
    return {
  ...
  var theme = (0, react_1.useMemo)(
    function () {
      return (0, styles_1.createTheme)(getDesignTokens(mode))
    },
    [mode],
  )
  return (
          ...
          <styles_1.ThemeProvider theme={theme}>
            ...
            <react_router_dom_1.BrowserRouter>
              <react_router_dom_1.Routes>
                ...
                <react_router_dom_1.Route
                  path='/contacts'
                  element={<contacts_1.Contacts />}
                />
                <react_router_dom_1.Route
                  path='/contacts/:id'
                  element={<contact_details_1.ContactDetails />}
                />
                <react_router_dom_1.Route
                  path='/next-steps'
                  element={<next_steps_1.NextSteps />}
                />
                <react_router_dom_1.Route
                  path='/next-steps/:id'
                  element={<ResourceView_1.ResourceView />}
                />
                <react_router_dom_1.Route
                  path='/job-applications'
                  element={<applications_1.Applications />}
                />
                <react_router_dom_1.Route
                  path='/interviews'
                  element={<interviews_1.Interviews />}
                />
                <react_router_dom_1.Route
